...
pub const styles = .{
    ...
    .separator = style.Style{ .foreground = .{ .red = 0x30, .green = 0x30, .blue = 0x30 }, .background = .{ .red = 0x1c, .green = 0x1c, .blue = 0x1c } },
    ...
    .python_cap_left = style.Style{ .foreground = .{ .red = 0xff, .green = 0xde, .blue = 0x57 }, .background = .{ .red = 0x1c, .green = 0x1c, .blue = 0x1c } },
    .python = style.Style{ .foreground = .{ .red = 0x1c, .green = 0x1c, .blue = 0x1c }, .background = .{ .red = 0xff, .green = 0xde, .blue = 0x57 } },
    .python_cap_right = style.Style{ .foreground = .{ .red = 0xff, .green = 0xde, .blue = 0x57 } },
    .kubernetes = style.Style{ .foreground = .{ .red = 0x32, .green = 0x6c, .blue = 0xe5 }, .background = .{ .red = 0x1c, .green = 0x1c, .blue = 0x1c } },
    .aws = style.Style{ .foreground = .{ .red = 0xff, .green = 0x99, .blue = 0x00 }, .background = .{ .red = 0x1c, .green = 0x1c, .blue = 0x1c } },
...
pub const top_template =
    "{{style.line}}╭─{{/style}}{{style.panel}} {{os}}{{if.directory}}{{style.separator}} {{/style}}{{directory}}{{/if}}{{if.git}}{{style.separator}} {{/style}}{{git_provider}}{{git_branch}}{{git_commit}}{{git_state}}{{git_status}}{{/if}}{{/style}}{{style.cap_right}}{{/style}}{{fill}}{{style.cap_left}}{{/style}}{{status}}{{if.python}}{{style.python_cap_left}}{{/style}}{{python}}{{style.python_cap_right}}{{/style}}{{/if}}{{if.kubernetes}}{{style.separator}}│ {{/style}}{{kubernetes}}{{/if}}{{if.aws}}{{style.separator}}│ {{/style}}{{aws}}{{/if}}{{style.line}}─╮{{/style}}";
